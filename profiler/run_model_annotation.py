...
def annotate_mlir_model(
        ...
        annotated_model_output_path: Path) -> ir.Module:
    """"Annotate model from with config and save to path. Returns annotated module string"""
...
def run_benchmark_module(
    ...
    benchmark_binary_path = Path(
        "/usr/local/google/home/kooljblack/Code/SHARK/0617_venv/lib/python3.10/site-packages/iree/runtime/iree-benchmark-module")
    module_file_arg = "--module_file=" + str(module_path)
...
def main(args: argparse.ArgumentParser):
    ...
    run_benchmark_module(vmfb_path, entry_function="forward")
    ...
    benchmark_results = benchmark_module(
        vm_module, device="cuda", benchmark_repetitions=5, batch_size=1000)
